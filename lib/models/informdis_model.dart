...
class InformDisModel {
  ...
  factory InformDisModel.fromMap(Map<String, dynamic> map) {
    return InformDisModel(
      ...
      inform_date:
          map['inform_date'] != null ? map['inform_date'] as String : null,
      fullname: map['fullname'] != null ? map['fullname'] as String : null,
      status_name: map['status_name'] as String,
      inform_tel: map['inform_tel'] as String,
      inform_images:
          map['inform_images'] != null ? map['inform_images'] as String : null,
      inform_remark:
          map['inform_remark'] != null ? map['inform_remark'] as String : null,
  ...
  factory InformDisModel.fromJson(String source) =>
      InformDisModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'InformDisModel(cid: $cid, inform_name: $inform_name, inform_key: $inform_key, inform_detail: $inform_detail, inform_place: $inform_place, inform_date: $inform_date, fullname: $fullname, status_name: $status_name, inform_tel: $inform_tel, inform_images: $inform_images, inform_remark: $inform_remark, lat: $lat, lng: $lng)';
  }

  @override
  bool operator ==(covariant InformDisModel other) {
