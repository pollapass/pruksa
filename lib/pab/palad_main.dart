...
import 'package:pruksa/pab/pab_post.dart';
import 'package:pruksa/utility/my_constant.dart';

class paladmain extends StatefulWidget {
  const paladmain({Key? key}) : super(key: key);

  @override
  State<paladmain> createState() => _paladmainState();
}

class _paladmainState extends State<paladmain> {
  bool load = true;
