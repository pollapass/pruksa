...
class editbooksend extends StatefulWidget {
  final booksendmodels bookModels;
  const editbooksend({Key? key, required this.bookModels}) : super(key: key);

  @override
  State<editbooksend> createState() => _editbooksendState();
}

class _editbooksendState extends State<editbooksend> {
  booksendmodels? bookModels;
  ...
  void initState() {
    ...
    titleController.text = bookModels!.book_name;
        ...
        builder: (context, constraints) => GestureDetector(
          ...
          child: Form(
            ...
            child: ListView(
              ...
              children: [
                Text(
                  'จัดทำโดย ${bookModels!.fullname} สังกัด ${bookModels!.dep_name} ',
  ...
  Future<Null> processEdit() async {
    if (formKey.currentState!.validate()) {
      ...
      String id = bookModels!.book_key;

      String apiEditProduct =
          '${MyConstant.domain}/dopa/api/edit_booksend.php?isUpdate=true&id=$id&remark=$titel';
  ...
  Future<Null> processdel() async {
    ...
    String apiEditProduct =
        '${MyConstant.domain}/dopa/api/del_booksend.php?isDelete=true&id=$id';
