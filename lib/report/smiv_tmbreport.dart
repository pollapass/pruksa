...
import 'package:pruksa/models/rsmiv_visit_model.dart';
...
class smivtmbreport extends StatefulWidget {
  const smivtmbreport({Key? key}) : super(key: key);

  @override
  State<smivtmbreport> createState() => _smivtmbreportState();
}

class _smivtmbreportState extends State<smivtmbreport> {
  ...
  List<smvisitmodel> revisitmodel = [];
  bool? haveData;
  bool load = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('ข้อมูลการเยี่ยมผู้ป่วยจิตเวช อสม'),
      ),
      body: LayoutBuilder(
                                          ...
                                          child: Container(
                                            ...
                                            child: ListTile(
                                              ...
                                              subtitle:
                                                  ...
                                                  Text(
                                                      ' ที่อยู่${revisitmodel[index].address} หมู่ที่ ${revisitmodel[index].moopart} ${revisitmodel[index].fulladdress}',
                                                      style: TextStyle(
                                                          color: Color.fromARGB(
                                                              255,
                                                              28,
                                                              ...
                                                              28))),
                                              title: Text(
                                                '${revisitmodel[index].sm_name} วันที่เยี่ยม ${revisitmodel[index].visit_date}',
                                                style: TextStyle(
                                                    color: Color.fromARGB(
                                                        255, 7, 7, 7),
                                                    fontWeight:
  ...
  Future<Null> loadmemberfromapi() async {
    ...
    String apigetmemberlist =
        '${MyConstant.domain}/dopa/api/getvisitsmiv.php?isAdd=true&sdate=$sdate&edate=$edate';
